...
public class LectureController {
	...
	@GetMapping("/research/faculty/{schoolId}/{statusId}")
	public List<ResearchDTO> getAllResarchSchoolStatusFaculty(@PathVariable long schoolId, @PathVariable long statusId){
		return researchService.getAllResearchBySchoolYearStatus(schoolId, statusId);
	}
	
	@GetMapping("/research/faculty/{statusId}")
	public List<ResearchDTO> getAllResarchStatusFaculty(@PathVariable long statusId){
		return researchService.getAllResearchByStatus(statusId);
	}
	/// Login 
	@PostMapping("/login")
	...
	public List<ResearchStatusDTO> getAllResearchStatus(){
		return researchStatusService.getAll();
	}
}
